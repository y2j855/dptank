...
public class Audio {
	...
	public Audio(String fileName) {
		try {
			audioInputStream = AudioSystem.getAudioInputStream(com.tony.tank.Audio.class.getClassLoader().getResource(fileName));
	...
	public static void main(String[] args) {
		...
		com.tony.tank.Audio a = new com.tony.tank.Audio("audio/war1.wav");
		a.loop();
